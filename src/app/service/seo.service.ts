...
export class SeoService {
  ...
  private siteName = 'Deepak Adhikari';
      ...
      .subscribe(route => {
        ...
        if (routeData) {
          ...
          this.updatePageMetadata({
            title: routeData['title'] || 'Deepak Adhikari | Full-Stack Developer | Angular & .NET Expert | Portfolio',
  ...
  updatePageMetadata(metadata: PageMetadata): void {
    ...
    const formattedTitle = metadata.title === 'Home'
      ? 'Deepak Adhikari | Full-Stack Developer'
  ...
  updateSeoForRoute(route: string, metadata: Partial<PageMetadata>): void {
    ...
    this.updatePageMetadata({
      title: metadata.title || 'Deepak Adhikari | Full-Stack Developer | Angular & .NET Expert | Portfolio',
